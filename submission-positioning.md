...
**TikTok Shop Product Scout: A Governed Product-Selection Operator for Affiliate Creators**

## One-line Position

A folder-based AI operator that turns TikTok Shop product scouting from gut instinct into a governed **PROMOTE / SKIP / WATCHLIST** decision workflow.
...
**Technical** would overstate the submission. There is no app, API, runner, or executable automation layer. The system is intentionally folder-based and model-executed.

**Creator** would undersell the submission. The creator is the user, but the output is not only a content artifact. The folder decides whether a product deserves creator effort before filming starts.

**Business** fits the actual job: reduce bad product bets, prevent risky promotions, preserve creator trust, and turn product selection into a repeatable operating process.
...
## What the Presentation Wrapper Should Show

1. **Before:** a creator sees a viral product and has an ambiguous decision.
2. **Operator:** the folder forces a clear path through disqualifiers, scoring, thresholds, and edge cases.
3. **After:** the creator receives one business action in a required format.

## Proof Boundaries

The submission should not claim that it predicts revenue, guarantees sales, automates TikTok Shop access, or replaces human legal review.

It can safely claim that it:

- structures product-selection judgment;
