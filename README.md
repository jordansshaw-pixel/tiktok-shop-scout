...
This is a business decision workflow for affiliate creators: it turns messy TikTok Shop product signals into a governed **PROMOTE / SKIP / WATCHLIST** call before filming time, audience trust, or compliance risk is spent. The creator use case is the demo; the underlying pattern is governed AI judgment.

See `submission-positioning.md` for the judge-facing submission definition.
...
Example video with captions: https://youtube.com/shorts/xiNW8VM4dcg
